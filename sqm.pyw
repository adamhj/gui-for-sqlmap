...
class app(Frame):
    def __init__(self, mw):
        ...
        rbREQUEST =ttk.Radiobutton(targetVariant,text='requestFile',variable=self.varTarget,value="requestFile", command=self.fTarget)
        rbDork = ttk.Radiobutton(targetVariant,text='googleDork',variable=self.varTarget,value="googleDork", command=self.fTarget)
        rbDirect = ttk.Radiobutton(targetVariant,text='direct',variable=self.varTarget,value="direct", command=self.fTarget)
        rbConfig = ttk.Radiobutton(targetVariant,text='configFile',variable=self.varTarget,value="configFile", command=self.fTarget)
